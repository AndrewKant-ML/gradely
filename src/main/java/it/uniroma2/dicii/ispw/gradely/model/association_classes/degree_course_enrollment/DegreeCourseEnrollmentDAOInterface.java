...
public interface DegreeCourseEnrollmentDAOInterface {
     ...
     * @param degreeCourseEnrollment the object to delete
     * @throws DAOException thrown if errors occur while retrieving data from persistence layer
     * @throws PropertyException thrown if errors occur while loading properties from .properties file
     * @throws ResourceNotFoundException thrown if the properties resource file cannot be found
     */
    void delete(DegreeCourseEnrollment degreeCourseEnrollment) throws DAOException, PropertyException, ResourceNotFoundException;
