...
import it.uniroma2.dicii.ispw.gradely.daos.factories.DAOFactoryDB;
...
public class SubjectCourseLazyFactory {
    ...
    public SubjectCourse getSubjectCourseByName(String name) {
        ...
        return DAOFactoryDB.getDAOFactory().getSubjectCourseDAO().getSubjectCourseByName(name); //TODO implementare exception
    }
}
